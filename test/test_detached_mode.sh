...
# Tests: E-ANCHORS-DETACHED-MODE-DETECTION, E-ANCHORS-DETACHED-EXTERNAL-FRONTMATTER,
#        E-ANCHORS-DETACHED-IN-REPO-FRONTMATTER, E-ANCHORS-DETACHED-PATH-RESOLUTION,
...
echo "  [1] E-ANCHORS-DETACHED-MODE-DETECTION: Detect mode from mode: detached field"
...
echo "  [2] E-ANCHORS-DETACHED-EXTERNAL-FRONTMATTER: External detached has repo, ref, path"
...
echo "  [3] E-ANCHORS-DETACHED-IN-REPO-FRONTMATTER: In-repo detached has path, no repo/ref"
...
echo "  [4] E-ANCHORS-DETACHED-PATH-RESOLUTION: In-repo path resolves relative to ANCHORS.md"
...
echo "  [5] E-ANCHORS-DETACHED-FORWARD-REF-FORMAT: Forward refs use → file:symbol"
...
echo "  [6] E-ANCHORS-DETACHED-FORWARD-REF-VALIDATION: Validate forward refs with path scoping"
...
echo "  [7] E-ANCHORS-DETACHED-NO-INLINE-TAGS: Target code has no inline req tags"
...
echo "  [8] E-ANCHORS-EMBED-PREREQ: Embedded module has no mode: detached"
assert_no_grep "Embedded module cannot be embedded (no mode: detached)" '^mode: detached' "$EMBEDDED/ANCHORS.md"

echo "  [9] E-ANCHORS-EMBED-STRIP-FORWARD-REFS: ERD has → lines to strip"
...
echo "  [10] E-ANCHORS-EMBED-STRIP-FRONTMATTER: Detached frontmatter has fields to strip"
